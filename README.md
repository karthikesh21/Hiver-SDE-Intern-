...
- **Dangerous False Auto Handles:** 06 / 67 (8.96% hazard rate vs. 73.1% for ML baseline, 100% for Majority)
- **Tests:** 22/22 passing
...
| **My AI Customer Support Agent** | **77.00%** | **0.7650** | **0.7759** | **0.7700** | **61.50%** | **46.21%** | **91.04%** | **61.31%** | **06 / 67 (8.96% hazard rate)** |
